...
class Slider extends React.Component {
	...
	// componentDidMount() = метод отвечает за то, что что-то выполнится,
	// когда элемент появится на странице
	componentDidMount() {
		this.interval = setInterval(() => this.intervalBetweenSlides(), 300)
	}
	// componentWillUnmount() = метод отвечает за то, что что-то выполнится,
	// когда элемент пропадет со страницы
